        ...
        },
        {
          ...
          data: {
            text: {
              twitter: false,
              header: "Workshops",
              text: '<p>Date: January 14, 2020<br>Location: Siili Solutions, <a href="https://goo.gl/maps/CPUAifmpZ56sTUaH9">Ruoholahdenkatu 21</a><br>Prices are 350€ for a half day workshop and 450€ for a full day workshop.<br><a href="https://www.lyyti.fi/reg/robocon2020workshops" target="blank">Tickets available here!</a></p>',
              talks: [
                ...
                { type: "workshop", author: "Elias Hachichou, Kristina Sabotic",
                  ...
                  description: "09:00-12:00<br>Welcome to this fun group exercise in how to build end-to-end test flows that can cover any type of interface for multiple applications in the same script. It will be a bonanza in problem solving, trying new libraries, exploring new ways of working – and music!",
                ...
                { type: "workshop", author: "Joshua Gorospe", title: "Strategies for creating your own conversational test assistant with Robot Framework and other tools",
                  description: "13:00-16:00<br>Wouldn't it be nice to have a conversational approach to working with Robot Framework? In this workshop I will share some examples to help you come up with ideas to make your own conversational test assistant.",
